...
\begin{table}[h]
    ...
    \vspace{5mm} \includegraphics[width=2cm]{logo} & \vspace{9mm} The projet a été réalisé par \textbf{Johan GIRARD} et  \textbf{Pierre ODIN} dans le cadre du cours de JML du M2PGI. Les tests ont été réalisés sous l'environnement Linux des machines de l'UFR IM²AG.
